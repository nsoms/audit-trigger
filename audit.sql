...
CREATE INDEX logged_actions_table_row_id_idx ON audit.logged_actions(table_name, row_id);
CREATE INDEX logged_actions_table_row_id_upd_idx ON audit.logged_actions(table_name, row_id, action_tstamp_stm);
